...
set_window_value(AT_FTILT, 2, AG_WINDOW_ANIM_FRAMES, 8);
...
set_window_value(AT_FTILT, 4, AG_WINDOW_ANIM_FRAME_START, 17);
...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 84);
...
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 84);
...
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 84);
...
set_hitbox_value(AT_FTILT, 5, HG_HITBOX_X, 56);
set_hitbox_value(AT_FTILT, 5, HG_HITBOX_Y, -36);
set_hitbox_value(AT_FTILT, 5, HG_WIDTH, 80);
set_hitbox_value(AT_FTILT, 5, HG_HEIGHT, 76);
